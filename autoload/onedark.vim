...
let s:colors = {
      ...
      \ "green": get(s:overrides, "green", { "gui": "#a3be86", "cterm": "114", "cterm16": "2" }),
      ...
      \ "blue": get(s:overrides, "blue", { "gui": "#658cb2", "cterm": "39", "cterm16": "4" }),
      \ "purple": get(s:overrides, "purple", { "gui": "#b48ead", "cterm": "170", "cterm16": "5" }),
      \ "cyan": get(s:overrides, "cyan", { "gui": "#96b5b4", "cterm": "38", "cterm16": "6" }),
      \ "white": get(s:overrides, "white", { "gui": "#c0c5ce", "cterm": "145", "cterm16": "7" }),
      \ "black": get(s:overrides, "black", { "gui": "#2b303b", "cterm": "235", "cterm16": "0" }),
